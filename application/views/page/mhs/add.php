		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						<div class="col-7">
					        <?php echo form_open('mhs/add',array("class"=>"form-horizontal")); ?>
							<div class="mb-3">
								<div class="row-sm-3">
									<label for="NIM">NIM</label>
								</div>
								<div class="row-sm-9">
									<input type="number" min="0" class="form-control" name="NIM" id="NIM" placeholder="Type here" required>
								</div>
							</div>
							<div class="mb-3">
								<div class="row-sm-3">
								...
								<div class="row-sm-9">
									<input type="text" class="form-control" name="mhs_nama" id="mhs_nama" placeholder="Type here" required>
								</div>
							</div>
							<div class="mb-3">
								<div class="row-sm-3">
								...
								<div class="row-sm-9">
									<input type="text" class="form-control" name="mhs_tpt_lhr" id="mhs_tpt_lhr" placeholder="Type here" required>
								</div>
							</div>
							<div class="mb-3">
								<div class="row-sm-3">
								...
								<div class="row-sm-9">
									<input type="date" class="form-control" name="mhs_tgl_lhr" id="mhs_tgl_lhr" placeholder="Type here" required>
								</div>
							</div>
							<div class="mb-3">
								<div class="row-sm-3">
							...
							<div class="mb-3">
								...
								<div class="row-sm-10">
									<input type="number" step="any" min="0" class="form-control" name="mhs_ipk" id="mhs_ipk" placeholder="Type here" required>
								</div>
							</div>
							<div class="mb-12">
