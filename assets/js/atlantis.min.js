...
$(".nav-search .input-group > input").focus(function (a) {
    ...
    if (!g) {
        ...
        $(".wrapper").hasClass("sidebar_minimize") && (v = 1, k.addClass("toggled"), k.html('<i class="fas fa-ellipsis-v"></i>')), k.on("click", function () {
            1 == v ? ($(".wrapper").removeClass("sidebar_minimize"), k.removeClass("toggled"), k.html('<i class="fas fa-bars"></i>'), v = 0) : ($(".wrapper").addClass("sidebar_minimize"), k.addClass("toggled"), k.html('<i class="fas fa-ellipsis-v"></i>'), v = 1), $(window).resize()
        }), g = !0
    }
    if (!p) {
    ...
    $(".wrapper").hasClass("is-show") && (b = 1, y.addClass("toggled"), y.html('<i class="fas fa-ellipsis-v"></i>')), y.on("click", function () {
        1 == b ? ($(".wrapper").removeClass("is-show"), y.removeClass("toggled"), y.html('<i class="fas fa-bars"></i>'), b = 0) : ($(".wrapper").addClass("is-show"), y.addClass("toggled"), y.html('<i class="fas fa-ellipsis-v"></i>'), b = 1), $(window).resize()
